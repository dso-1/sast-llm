...
Contoh:
  ...
  python run_all.py --only-compare
    ...
    parser.add_argument('--skip-check', action='store_true', help='Skip pengecekan prasyarat')
    ...
    result_files = list(Path(args.output).glob("*.json")) + list(Path(args.output).glob("*.html"))
